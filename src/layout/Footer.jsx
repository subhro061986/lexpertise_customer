...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-[#e6dedb]">
      {/* ================= CONTENT ================= */}
      <div className="max-w-md mx-auto px-6 py-12 lg:max-w-7xl lg:px-10 lg:py-16">
        {/* ================= MOBILE STACK ================= */}
        <div className="space-y-10 lg:hidden">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-[#6d544b] leading-relaxed">
              Plot 13, Heritage Phase II Telephone Nagar, Perungudi Chennai -
              600096
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#6d544b]">U22219TN2022PTC151260</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-[#6d544b]">sales@lexpertise.in</p>
              </div>

              <div className="flex items-center gap-2">
                <img src={calllogo} alt="Phone" className="h-4 w-4" />
                <p className="text-sm text-[#6d544b]">+1 (650) 555-0111</p>
              </div>
            </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-5 lg:gap-20">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-[#6d544b] leading-relaxed">
              Plot 13, Heritage Phase II <br />
              Telephone Nagar, Perungudi <br />
              Chennai - 600096
            </p>

            {/* CIN FIXED HERE */}
            <div className="flex items-start gap-2 text-sm mt-3">
              <span className="font-bold text-[#1B2053] whitespace-nowrap">
                CIN No:
              </span>
              <span className="text-[#6d544b]">U22219TN2022PTC151260</span>
            </div>
