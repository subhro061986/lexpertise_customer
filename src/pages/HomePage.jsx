    ...
    return (
      ...
      <TopMenu/>
        <main class="flex-grow flex flex-col items-center justify-start pt-12 pb-20 px-4 sm:px-6 relative">
          ...
          <div class="text-center max-w-3xl mb-10 space-y-4">
            <h2 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#181311] dark:text-white leading-[1.15]">
              Judicial&nbsp;
              <span class="text-primary relative inline-block secondary_color">
                 Database 
              </span>
            </h2>
            <p class="text-lg sm:text-xl color_1 font-medium max-w-2xl mx-auto">
              Instant access to millions of judgments, orders, and case statuses from Supreme, High, and District Courts.
            </p>
          </div>
          <div class="w-full max-w-5xl bg-white dark:bg-[#2e1d19] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-[#e6dedb] dark:border-[#3e2c26] overflow-hidden">
            <div class="border-b border-[#e6dedb] dark:border-[#3e2c26] bg-[#faf8f7] dark:bg-[#251815] px-6 py-4">
              <label class="text-sm font-bold tracking-wider color_1 mb-3 block">Select Court Level</label>
          ...
          <div class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl w-full px-4">
            <div class="flex flex-col items-center text-center gap-3">
              <div class="bg-white dark:bg-[#2e1d19] p-3 rounded-full shadow-sm">
                <img src={secure_access_img} alt="Secure Access" class="text-primary"/>
              </div>
              <h3 class="font-bold text-[#181311] dark:text-white">Secure Access</h3>
              <p class="text-sm dark:text-[#a08d87]">Encrypted database access ensuring privacy and security for sensitive legal data.</p>
            </div>
            <div class="flex flex-col items-center text-center gap-3">
              <div class="bg-white dark:bg-[#2e1d19] p-3 rounded-full shadow-sm">
                <img src={monthly_update_img} alt="Monthly Updates" class="text-primary"/>
              </div>
              <h3 class="font-bold text-[#181311] dark:text-white">Monthly Updates</h3>
              <p class="text-sm dark:text-[#a08d87]">Daily updates from over 3,000 courts across the country.</p>
            </div>
            <div class="flex flex-col items-center text-center gap-3">
              <div class="bg-white dark:bg-[#2e1d19] p-3 rounded-full shadow-sm">
                <img src={advance_filling_img} alt="Advanced Filing" class="text-primary"/>
              </div>
              <h3 class="font-bold text-[#181311] dark:text-white">Advanced Filing</h3>
              <p class="text-sm dark:text-[#a08d87]">Comprehensive case history with digitized document archives.</p>
            </div>
          </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                  ...
                  <h2 class="text-3xl md:text-4xl font-bold text-[#181311] dark:text-white leading-tight">
                    Connecting You to the <span class="text-primary">Justice System</span>
                  </h2>
                  <p class="dark:text-[#a08d87] text-lg leading-relaxed">
                    LexSearch offers a comprehensive suite of tools designed to simplify legal research. From instant case retrieval to advanced analytics, we empower users with the data they need to make informed decisions.
                  </p>
                </div>
                <div class="grid gap-6">
                  <div class="bg-white dark:bg-[#2e1d19] p-6 rounded-xl shadow-sm border border-[#e6dedb] dark:border-[#3e2c26] transition-transform hover:-translate-y-1 duration-300">
                    <div class="flex gap-4">
                      ...
                      <div>
                        <h3 class="font-bold text-lg text-[#181311] dark:text-white mb-2">Our Mission</h3>
                        <p class="text-sm dark:text-[#a08d87]">To create the most accessible, transparent, and reliable national judicial database for every citizen.</p>
                      </div>
                    </div>
                  </div>
                  <div class="bg-white dark:bg-[#2e1d19] p-6 rounded-xl shadow-sm border border-[#e6dedb] dark:border-[#3e2c26] transition-transform hover:-translate-y-1 duration-300">
                    <div class="flex gap-4">
                      ...
                      <div>
                        <h3 class="font-bold text-lg text-[#181311] dark:text-white mb-2">Our Values</h3>
                        <p class="text-sm dark:text-[#a08d87]">We are driven by integrity, accuracy, and a commitment to public service in everything we build.</p>
                      </div>
                    </div>
                  </div>
                </div>
