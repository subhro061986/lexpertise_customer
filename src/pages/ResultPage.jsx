      ...
      {/* <TopMenu/> */}
        <main className="flex-1 max-w-[1440px] w-full mx-auto px-4 lg:px-8 py-6 lg:py-8 flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-80 shrink-0 flex flex-col gap-6">
            ...
            {/* <div className="hidden lg:flex flex-col gap-6 bg-white dark:bg-[#1a2632] p-5 rounded-lg border border-[#dbe0e6] dark:border-slate-700 shadow-sm sticky top-24 max-h-[calc(100vh-8rem)] overflow-y-auto"> */}
              ...
              <div className="flex items-center justify-between border-b border-[#f0f2f4] dark:border-slate-700 pb-4">
                ...
                <a className="text-sm text-primary font-medium hover:underline" href="#">Reset All</a>
              </div>
              <div className="flex flex-col gap-3">
                <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Court Category</label>
                <div className=" selected_tab_color rounded-full flex flex-col gap-2 w-50">
                  <label className="flex text-center items-center gap-3 p-2.5 ">
                    <span className="text-sm font-medium text-[#111418] dark:text-slate-300">Supreme Court</span>
                  </label>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 mt-2">
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Select State</label>
                ...
                <div className="flex flex-col gap-2 opacity-50 cursor-not-allowed" title="Select District Court to enable">
                  <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Select District</label>
                  <select className="w-full h-11 pl-3 pr-8 rounded-lg input_border dark:border-slate-600 bg-[#f6f7f8] dark:bg-slate-900 text-sm focus:border-primary focus:ring-0 text-[#617589]" disabled="">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Case Category</label>
                  <select className="w-full h-11 pl-3 pr-8 rounded-lg input_border dark:border-slate-600 bg-white dark:bg-slate-800 text-sm focus:border-primary focus:ring-0 text-[#111418] dark:text-white">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Year</label>
                    <select className="w-full h-11 pl-3 pr-8 rounded-lg input_border dark:border-slate-600 bg-white dark:bg-slate-800 text-sm focus:border-primary focus:ring-0 text-[#111418] dark:text-white">
                      <option>2023</option>
                      <option>2022</option>
                      <option>2021</option>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Month</label>
                    <select className="w-full h-11 pl-3 pr-8 rounded-lg input_border dark:border-slate-600 bg-white dark:bg-slate-800 text-sm focus:border-primary focus:ring-0 text-[#111418] dark:text-white">
              ...
              <div className="flex flex-col gap-2 mt-2">
                <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Search By</label>
              ...
              <div className="flex flex-col gap-2 mt-2">
                <label className="text-sm font-medium text-[#111418] dark:text-slate-200">Search Keywords</label>
                <div className="relative">
                  <input className="w-full h-11 pl-4 pr-10 rounded-lg input_border dark:border-slate-600 bg-white dark:bg-slate-800 text-sm focus:border-primary focus:ring-0 placeholder:text-[#617589]" placeholder="Case No / Key Word" type="text" />
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <div className="flex items-center gap-2 text-sm text-[#617589] mb-6">
              ...
              <span>/</span>
              <span className="font-medium text-[#111418] dark:text-white">Search Results</span>
            </div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <h2 className="text-2xl font-bold text-[#111418] dark:text-white">1,240 Results found</h2>
                <p className="text-sm text-[#617589] mt-1">Showing results for "State of Karnataka"</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-[#617589]">Sort by:</span>
                <div className="relative">
              ...
              <div className="group bg-white dark:bg-[#1a2632] p-5 rounded-lg border border-[#dbe0e6] dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-full relative">
                ...
                <div>
                  <div className="flex flex-col gap-2 mb-4 pr-14">
                    <a className="text-lg font-bold text-primary hover:underline leading-snug block line-clamp-2" href="#">
            ...
            <div className="flex items-center justify-between border-t border-[#dbe0e6] dark:border-slate-700 pt-6 mt-8">
              ...
              <div className="flex items-center gap-1">
                <button className="h-9 w-9 flex items-center justify-center rounded-lg bg-primary text-white text-sm font-medium">1</button>
                <button className="h-9 w-9 flex items-center justify-center rounded-lg text-[#617589] hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors">2</button>
                <button className="h-9 w-9 flex items-center justify-center rounded-lg text-[#617589] hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors">3</button>
                <span className="px-2 text-[#617589]">...</span>
                <button className="h-9 w-9 flex items-center justify-center rounded-lg text-[#617589] hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors">12</button>
              </div>
